...
def main() -> None:
    ...
    compact_monomial_export(monomial_runs).to_csv(monomial_runs_path, index=False, lineterminator="\n")
    compact_monomial_export(monomial_triangles).to_csv(monomial_triangles_path, index=False, lineterminator="\n")
