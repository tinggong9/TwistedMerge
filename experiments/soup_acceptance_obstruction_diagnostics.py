...
- Prompt 22 did not log validation metrics for rejected averaged candidate soups. This report therefore models direct acceptance labels and validation-quality proxy margins, and it marks true rejected-candidate degradation as unlogged.
