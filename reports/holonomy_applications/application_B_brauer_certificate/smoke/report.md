...
Executed command: `/Users/tinggong/Documents/GitHub/TwistedMerge/.venv/bin/python experiments/holonomy_application_B.py --mode smoke`

## Result

- Natural adapter corpus only; no adapter training and no test-label access.
- Medium-threshold classification counts: `{'noncentral_holonomy': 3, 'trivial_coboundary': 1}`.
- Application-A-selected connection classifications: `{'trivial_coboundary': 1}`.
- Natural central finite-order candidates: `0`.
- Settings whose label is unchanged across strict/medium/loose thresholds: `4` / `4`.
