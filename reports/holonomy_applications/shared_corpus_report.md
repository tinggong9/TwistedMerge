...
Decision: **complete confirmatory corpus construction**.

## Exact command

```bash
/Users/tinggong/Documents/GitHub/TwistedMerge/.venv/bin/python experiments/holonomy_shared_corpus.py --mode confirmatory --data-dir /Users/tinggong/Documents/GitHub/TwistedMerge/data --device auto
```
...
- Independent model-training seeds: [0, 1, 2, 3, 4]
- Successful chart adapters: 40 / 40
- Mean validation accuracy: 0.623633
- Worst chart/seed validation accuracy: 0.582031
