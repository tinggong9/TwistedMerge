...
| Controlled `S_3` permutation commutators are noncentral and not Brauer/projective scalar classes. | Supported | `test_s3_commutator_is_noncentral` verifies the `(12),(23)` commutator is a noncentral 3-cycle; `reports/noncentral_vs_brauer_note.tex` records the concise example. |
...
| `reports/noncentral_vs_brauer_note.tex` | Concise note on why noncentral permutation holonomy is not a scalar Brauer/projective class. |
...
| `reports/optimized_global_block_synchronization_report.md` | Verification report for benchmark series 5(j)(ii), including exact commands, calibration, synthetic controls, and negative boundaries. |
...
| claim_id | status | evidence | safe_wording | unsupported_wording |
| --- | --- | --- | --- | --- |
...
Use `experiments/model_merging_fixed_setting_verification.py` for the next confirmatory real verification run. Keep `experiments/model_merging_benchmark.py --mode verification` as historical/descriptive context only.
...
<!-- small-order-torsion:end -->

<!-- group-cohomology-torsion:start -->
...
<!-- group-cohomology-torsion:end -->

<!-- nonabelian-holonomy-splitting:start -->
...
<!-- nonabelian-holonomy-splitting:end -->

<!-- controlled-nonabelian-holonomy:start -->
## Controlled Nonabelian Holonomy Splitting Audit

Evidence status: `INVALID_AS_EMPIRICAL_ACCURACY_EVIDENCE` for every accuracy, loss, selector, paired-statistic, and capacity-performance claim in this block. `experiments/controlled_nonabelian_holonomy.py` generated candidate logits from method-specific target accuracies and evaluation labels. Only the standalone finite-group and invariant-pooling residual calculations remain structural-only; see `reports/next_benchmarks/stage0_evidence_audit.md`.
...
| invariant_pooling_kills_branch_holonomy | Supported structural-only | Analytic invariant pooling kills the planted single-element branch permutation; this is not an accuracy result. | reports/csv/controlled_nonabelian_holonomy_residuals.csv |
| branch_lift_recovers_planted_accuracy | Invalid | INVALID_AS_EMPIRICAL_ACCURACY_EVIDENCE: candidate predictions were generated from method-specific target accuracies and labels. | reports/next_benchmarks/stage0_invalid_artifacts.csv |
| selector_avoids_null_lifts | Invalid | INVALID_AS_EMPIRICAL_ACCURACY_EVIDENCE: selection operated on target-injected candidate metrics. | reports/next_benchmarks/stage0_invalid_artifacts.csv |
| branch_lift_capacity_boundary | Invalid empirical comparison | Capacity metadata is descriptive, but performance comparisons in the contaminated rows are invalid. | reports/next_benchmarks/stage0_invalid_artifacts.csv |
...
<!-- controlled-nonabelian-holonomy:end -->

<!-- small-quotient-holonomy:start -->
...
<!-- small-quotient-holonomy:end -->

<!-- primary-holonomy-splitting:start -->
...
<!-- primary-holonomy-splitting:end -->

## Sequential Quotient Lift Correction

| Claim | Status | Evidence |
| --- | --- | --- |
| Commit `9e743a0fd2cefced2c155e47e64466c23c4c9128` sequential quotient controlled accuracy tables are empirical evidence. | Not supported | `reports/sequential_quotient_lift_correction_note.md` documents method-dependent label injection through `signal_for` and `logits_from_signal`; regenerated CSVs remove prescribed accuracy. |
