...
| Official baseline integration | In progress | `external_baselines/POST_ICLR_INTEGRATION.md`; `post_iclr_official_baseline_report.md`; `csv/post_iclr_official_baseline_runs.csv`; `csv/post_iclr_baseline_regime_audit.csv` | No official win unless official source code runs on the exact checkpoint set. |
